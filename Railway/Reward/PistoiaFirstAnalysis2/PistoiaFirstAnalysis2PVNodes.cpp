...
PistoiaFirstAnalysis2PV0Impulse0::PistoiaFirstAnalysis2PV0Impulse0()
{
...
double PistoiaFirstAnalysis2PV0Impulse0::Impulse_Function(double FiringTime)
{
return (1.0);
...
ImpulseNodeClass** PistoiaFirstAnalysis2PV0Impulse0::CreateImpulseWorkerList(int NumberOfWorkers) {
  ...
  {
    ImpulseWorkerList[ImpulseWorkerCounter] = new PistoiaFirstAnalysis2PV0Impulse0;
  }

  return ImpulseWorkerList;
}

PistoiaFirstAnalysis2PV0Impulse1::PistoiaFirstAnalysis2PV0Impulse1()
{
  NumberOfModelDependencies = 1;
  TheModelPtr = new BaseModelClass**[NumberOfModelDependencies];
  TheModelPtr[0] = (BaseModelClass**)(&PistoiaFirst);
...
double PistoiaFirstAnalysis2PV0Impulse1::Impulse_Function(double FiringTime)
{
return (1.0);
...
ImpulseNodeClass** PistoiaFirstAnalysis2PV0Impulse1::CreateImpulseWorkerList(int NumberOfWorkers) {
  ImpulseWorkerListLength = NumberOfWorkers;
  ImpulseWorkerList = new ImpulseNodeClass*[NumberOfWorkers];

  for (int ImpulseWorkerCounter = 0; ImpulseWorkerCounter < NumberOfWorkers; ImpulseWorkerCounter++)
  {
    ImpulseWorkerList[ImpulseWorkerCounter] = new PistoiaFirstAnalysis2PV0Impulse1;
  }

  return ImpulseWorkerList;
}

PistoiaFirstAnalysis2PV0::PistoiaFirstAnalysis2PV0(int timeindex) {
...
PistoiaFirstAnalysis2PV0::~PistoiaFirstAnalysis2PV0() {
...
void PistoiaFirstAnalysis2PV0::CreateWorkerList(void) {
}
