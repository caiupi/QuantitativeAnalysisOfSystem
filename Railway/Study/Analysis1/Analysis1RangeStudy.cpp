...
#include "Study/Analysis1/Analysis1RangeStudy.h"
...
//********************************************************
//Analysis1RangeStudy Constructor
//********************************************************
Analysis1RangeStudy::Analysis1RangeStudy() {
...
//******************************************************
//Analysis1RangeStudy Destructor
//******************************************************
Analysis1RangeStudy::~Analysis1RangeStudy() {
  delete [] LValues;
  delete [] NValues;
...
// set values for L
//******************************************************
void Analysis1RangeStudy::SetValues_L() {
  LValues[0] = 6;
  LValues[1] = 6;
  LValues[2] = 6;
  LValues[3] = 6;
...
// set values for N
//******************************************************
void Analysis1RangeStudy::SetValues_N() {
  NValues[0] = 1;
  NValues[1] = 3;
  NValues[2] = 5;
  NValues[3] = 7;
...
// set values for P
//******************************************************
void Analysis1RangeStudy::SetValues_P() {
  PValues[0] = 4;
  PValues[1] = 4;
  PValues[2] = 4;
  PValues[3] = 4;
...
// set values for h
//******************************************************
void Analysis1RangeStudy::SetValues_h() {
  hValues[0] = 0.001;
  hValues[1] = 0.001;
  hValues[2] = 0.001;
  hValues[3] = 0.001;
...
//******************************************************
void Analysis1RangeStudy::PrintGlobalValues(int expNum) {
  if (NumGVs == 0) {
...
//******************************************************
void *Analysis1RangeStudy::GetGVValue(char *TheGVName) {
  if (strcmp("L", TheGVName) == 0)
    ...
    cerr<<"!! Analysis1RangeStudy::GetGVValue: Global Variable "<<TheGVName<<" does not exist."<<endl;
  return NULL;
}
...
//******************************************************
void Analysis1RangeStudy::OverrideGVValue(char *TheGVName,void *TheGVValue) {
  if (strcmp("L", TheGVName) == 0)
    ...
    cerr<<"!! Analysis1RangeStudy::OverrideGVValue: Global Variable "<<TheGVName<<" does not exist."<<endl;
}
...
//******************************************************
void Analysis1RangeStudy::SetGVs(int expNum) {
...
BaseStudyClass * GenerateStudy() {
  if (GlobalStudyPtr == NULL)
    GlobalStudyPtr = new Analysis1RangeStudy();
...
//******************************************************
PVModel* Analysis1RangeStudy::GetPVModel(bool expandTimeArrays) {
  if (ThePVModel!=NULL)
    delete ThePVModel;
  // create the PV model
  ThePVModel=new LuccaFirstAnalisys1PVModel(expandTimeArrays);
  return ThePVModel;
}
