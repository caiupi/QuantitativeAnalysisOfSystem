...
#include "Study/LuccaFirstAnalysis4/LuccaFirstAnalysis4RangeStudy.h"
...
//********************************************************
//LuccaFirstAnalysis4RangeStudy Constructor
//********************************************************
LuccaFirstAnalysis4RangeStudy::LuccaFirstAnalysis4RangeStudy() {
...
//******************************************************
//LuccaFirstAnalysis4RangeStudy Destructor
//******************************************************
LuccaFirstAnalysis4RangeStudy::~LuccaFirstAnalysis4RangeStudy() {
  delete [] LValues;
  delete [] NValues;
...
// set values for L
//******************************************************
void LuccaFirstAnalysis4RangeStudy::SetValues_L() {
  LValues[0] = 6;
  LValues[1] = 6;
  LValues[2] = 6;
  LValues[3] = 6;
...
// set values for N
//******************************************************
void LuccaFirstAnalysis4RangeStudy::SetValues_N() {
  NValues[0] = 7;
  NValues[1] = 7;
  NValues[2] = 7;
  NValues[3] = 7;
...
// set values for P
//******************************************************
void LuccaFirstAnalysis4RangeStudy::SetValues_P() {
  PValues[0] = 4;
  PValues[1] = 4;
  PValues[2] = 4;
  PValues[3] = 4;
...
// set values for h
//******************************************************
void LuccaFirstAnalysis4RangeStudy::SetValues_h() {
  hValues[0] = 1.0E-5;
  hValues[1] = 1.0E-4;
  hValues[2] = 0.001;
  hValues[3] = 0.01;
...
//******************************************************
void LuccaFirstAnalysis4RangeStudy::PrintGlobalValues(int expNum) {
  if (NumGVs == 0) {
...
//******************************************************
void *LuccaFirstAnalysis4RangeStudy::GetGVValue(char *TheGVName) {
  if (strcmp("L", TheGVName) == 0)
    ...
    cerr<<"!! LuccaFirstAnalysis4RangeStudy::GetGVValue: Global Variable "<<TheGVName<<" does not exist."<<endl;
  return NULL;
}
...
//******************************************************
void LuccaFirstAnalysis4RangeStudy::OverrideGVValue(char *TheGVName,void *TheGVValue) {
  if (strcmp("L", TheGVName) == 0)
    ...
    cerr<<"!! LuccaFirstAnalysis4RangeStudy::OverrideGVValue: Global Variable "<<TheGVName<<" does not exist."<<endl;
}
...
//******************************************************
void LuccaFirstAnalysis4RangeStudy::SetGVs(int expNum) {
...
BaseStudyClass * GenerateStudy() {
  if (GlobalStudyPtr == NULL)
    GlobalStudyPtr = new LuccaFirstAnalysis4RangeStudy();
...
//******************************************************
PVModel* LuccaFirstAnalysis4RangeStudy::GetPVModel(bool expandTimeArrays) {
  if (ThePVModel!=NULL)
    delete ThePVModel;
  // create the PV model
